...
export default function RegistrationCert() {
  ...
  const showImageOptions = () => {
    Alert.alert('Add Registration Certificate', 'Choose how to add your photo', [
  ...
  const handleContinue = () => {
    if (!registrationImage) {
      Alert.alert('Document required', 'Please upload your vehicle registration certificate');
      return;
    }
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.requirementsCard}>
          ...
          <View style={styles.requirementRow}>
            ...
            <Text style={styles.requirementText}>Valid Cayman Islands vehicle registration</Text>
          </View>
          <View style={styles.requirementRow}>
            <Ionicons name="checkmark-circle" size={18} color={Colors.success} />
            <Text style={styles.requirementText}>Vehicle details must match your application</Text>
          </View>
          <View style={styles.requirementRow}>
            <Ionicons name="checkmark-circle" size={18} color={Colors.success} />
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoText}>
            Your vehicle registration proves legal ownership or authorization to operate this vehicle 
